...
(function($, P, _, exports) {
    ...
    LayoutManager.fn = LayoutManager.prototype = {
        ...
        onRemove : function(e) {
            ...
            if (lm.isElementDragging(item)) { // do not perform item remove while drag in progress
                return;
            }
            var pos = item.index(),
        ...
        add : function(nodes, pos, axisName) {
            ...
            if (_.isEmpty(nodes)) {
                ...
                this.element.trigger('lm:addItem', {axis : axisName, dimension : extra.dimensionId, level : extra.id, index : pos, hierarchyName : extra.hierarchyName});
            } else {
    ...
    LayoutManager.isElementDragging = function(element) {
            ...
            row : {
                ...
                validateAdd : function(nodes, pos, axisName, errorMessages) {
                    ...
                    var that = this, extra = nodes[0].param.extra,
                        columnDimensions = this.axes['olap_columns'].data;

                    return !_.isEmpty(nodes)
                        && !(this.axes['olap_rows'].isDependent &&
                            (_.isEmpty(columnDimensions) || extra.hierarchyName && columnDimensions.length === 1 && columnDimensions[0].groupId === extra.dimensionId))
