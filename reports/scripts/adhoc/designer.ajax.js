...
adhocDesigner.switchMode = function(requestedMode, undoOrRedo){
    ...
    designerBase.sendRequest(designerBase.getControllerPrefix() + '_switchMode', params, switchModeCallback);
};
...
adhocDesigner.pivot = function() {
    localContext.pivot ? localContext.pivot() : designerBase.sendRequest(designerBase.getControllerPrefix() + '_pivot', []);
};
