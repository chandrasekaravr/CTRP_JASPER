...
<%@ page import="com.jaspersoft.jasperserver.war.common.UserLocale,com.jaspersoft.jasperserver.war.dto.ByteEnum,
										...
										<fieldset class="group">
                                            ...
                                            <spring:bind path="job.contentRepositoryDestination.folderURI">
                                                ...
                                                <div title="" class="control browser">
                                                    ...
                                                    <input type="text" value="${status.value}" name="browseOutputLocation" id="browseOutputLocation">
