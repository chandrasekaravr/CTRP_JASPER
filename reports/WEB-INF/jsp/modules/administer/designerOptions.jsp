		...
		<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
		    ...
		    <t:putAttribute name="bodyContent">
                ...
                <%
    	            ...
    	            String intelligentChartsTurboThreshold = (String)request.getAttribute("intelligentChartsTurboThreshold");
...
<%-- This code is commented till Scatter chart is released because it can affect only Scatter chart. -->
<%--
                    <li class="node">
                        <div class="wrap">
                            <h2 class="title settingsGroup"><spring:message code="QG_108_ICHARTS"/></h2>
                        </div>
                        <p class="description"><spring:message code="QG_108_ICHARTS_EXPLAIN"/></p>
                        <ol class="list settings">

                            <%
                                request.setAttribute("oName", "intelligentChartsTurboThreshold");
                                request.setAttribute("oDesc", "QG_108_ICHARTS_TURBO_THRESHOLD");
                                request.setAttribute("oLabelCode", "QG_108_ICHARTS_TURBO_THRESHOLD_EXPLAIN");
                                request.setAttribute("oValue", intelligentChartsTurboThreshold);
                            %>
                            <jsp:include page="templateInputText.jsp" flush="true" />
                        </ol>
                    </li>
