...
adHocFilterModule.validateComplexFilter = function() {
    ...
    designerBase.sendRequest(adHocFilterModule.CONTROLLER_PREFIX + '_validateComplexFilter', new Array("complexFilterExpression=" + encodeText(expression)), callback, null);
};
...
adHocFilterModule.submitComplexFilter = function() {
    ...
    designerBase.sendRequest(adHocFilterModule.CONTROLLER_PREFIX + '_setComplexFilter', new Array("complexFilterExpression=" + encodeText(expression)), callback, null);
};
