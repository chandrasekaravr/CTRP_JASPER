...
var adhocDesigner = {
    ...
    */
    ...
    initComponents: function(mode){
        ...
        adHocFilterModule.DATE_FORMAT = adhocDesigner.CALENDAR_DATE_FORMAT;
        adHocFilterModule.TIME_FORMAT = adhocDesigner.CALENDAR_TIME_FORMAT;

        adHocFilterModule.DATE_REGEX = adhocDesigner.VALIDATION_DATE_PATTERN;
        adHocFilterModule.DATE_TIME_REGEX = adhocDesigner.VALIDATION_DATETIME_PATTERN;
    ...
    render: function(state){
        ...
        jQuery('#designer').trigger('layout_update', {isAdhocDesignerTriggered: true});
