    ...
    return _.extend(Controls,{
        ...
        DashboardRuntimeController:Controls.Controller.extend({
            ...
            initialize:function (args) {
                ...
                var dashboardControlsIds = _.keys(args.initialValues);

                return this.dataTransfer.fetchControlsStructure(dashboardControlsIds, args.initialValues).done(function(response){
